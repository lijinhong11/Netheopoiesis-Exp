...
public class TradePool {
    ...
    public static final TradePool CITRUS = new TradePool()
            ...
            .addTrade(Converter.getItem(SlimefunItems.MAGIC_LUMP_1), 0)
            .addTrade(Converter.getItem(SlimefunItems.ENDER_LUMP_1), 0)
    ...
    public TradePool addTrade(@Nonnull SlimefunItemStack itemStack, int requiredFlavour) {
        return addTrade(Converter.getItem(itemStack), requiredFlavour);
    }
