...
public class PurificationFlexGroup extends FlexItemGroup {
    ...
    private static final ItemStack SLEEP_STACK = ItemCreator.create(
            Material.BLACK_BED,
    ...
    private static final ItemStack WATER_STACK = ItemCreator.create(
            Material.BUCKET,
    ...
    private static final ItemStack REGEN_STACK = ItemCreator.create(
    ...
    private static final ItemStack MOBS_1_STACK = ItemCreator.create(
            Material.SPAWNER,
    ...
    private static final ItemStack MOBS_2_STACK = ItemCreator.create(
            Material.SPAWNER,
    ...
    private static final ItemStack PIGLIN_STACK = ItemCreator.create(
    ...
    private static final ItemStack BARTERING_STACK = ItemCreator.create(
            Material.GOLD_INGOT,
    ...
    private static final ItemStack ENDER_CAKE = ItemCreator.create(
            Material.CAKE,
