...
public class PurificationFlexGroup extends FlexItemGroup {
    ...
    private static final ItemStack SLEEP_STACK = CustomItemStack.create(
        Material.BLACK_BED,
    ...
    private static final ItemStack WATER_STACK = CustomItemStack.create(
        Material.BUCKET,
    ...
    private static final ItemStack REGEN_STACK = CustomItemStack.create(
    ...
    private static final ItemStack MOBS_1_STACK = CustomItemStack.create(
        Material.SPAWNER,
    ...
    private static final ItemStack MOBS_2_STACK = CustomItemStack.create(
        Material.SPAWNER,
    ...
    private static final ItemStack PIGLIN_STACK = CustomItemStack.create(
    ...
    private static final ItemStack BARTERING_STACK = CustomItemStack.create(
        Material.GOLD_INGOT,
    ...
    private static final ItemStack ENDER_CAKE = CustomItemStack.create(
        Material.CAKE,
