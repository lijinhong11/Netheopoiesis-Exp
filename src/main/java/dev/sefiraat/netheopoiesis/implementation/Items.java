...
import dev.sefiraat.netheopoiesis.implementation.tools.*;
...
public final class Items {
    ...
    public static void setup(Netheopoiesis addon) {
        ...
        new SlimefunItem(
                ...
                new ItemStack[]{
                        Converter.getItem(Stacks.ADDON_BERRY)
                }
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.HARMONISED_CRYSTAL_FIRE),
                        NetheoBalls.BAD,
                        20
                )
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.HARMONISED_CRYSTAL_WATER),
                        NetheoBalls.ANCHOVY,
                        20
                )
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.HARMONISED_CRYSTAL_EARTH),
                        NetheoBalls.BERRY,
                        20
                )
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.HARMONISED_CRYSTAL_AIR),
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.DISCORDANT_CRYSTAL_FIRE),
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.DISCORDANT_CRYSTAL_WATER),
                        NetheoBalls.BONITO,
                        20
                )
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.DISSONANT_CRYSTAL_EARTH),
                        NetheoBalls.BROTHY,
                        20
                )
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.DISSONANT_CRYSTAL_AIR),
                        NetheoBalls.CANDY,
                        20
                )
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.DISSONANT_CRYSTAL_FIRE),
                        NetheoBalls.BITTERSWEET,
                        20
                )
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.DISSONANT_CRYSTAL_WATER),
                        NetheoBalls.BONITO,
                        20
                )
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                new ItemStack[]{
                        null, Converter.getItem(Stacks.HARMONISED_CRYSTAL_FIRE), null,
                        Converter.getItem(Stacks.HARMONISED_CRYSTAL_WATER), new ItemStack(Material.NETHER_STAR), Converter.getItem(Stacks.HARMONISED_CRYSTAL_EARTH),
                        null, Converter.getItem(Stacks.HARMONISED_CRYSTAL_AIR), null
                }
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeType.MAGIC_WORKBENCH,
                new ItemStack[]{
                        null, Converter.getItem(Stacks.DISCORDANT_CRYSTAL_FIRE), null,
                        Converter.getItem(Stacks.DISCORDANT_CRYSTAL_WATER), Converter.getItem(Stacks.ELEMENTAL_CRYSTAL), Converter.getItem(Stacks.DISSONANT_CRYSTAL_EARTH),
                        null, Converter.getItem(Stacks.DISSONANT_CRYSTAL_AIR), null
                }
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeType.MAGIC_WORKBENCH,
                new ItemStack[]{
                        null, Converter.getItem(Stacks.DISSONANT_CRYSTAL_FIRE), null,
                        Converter.getItem(Stacks.DISSONANT_CRYSTAL_WATER), Converter.getItem(Stacks.VACUUM_CRYSTAL), Converter.getItem(Stacks.DISSONANT_CRYSTAL_EARTH),
                        null, Converter.getItem(Stacks.DISSONANT_CRYSTAL_AIR), null
                }
        ).register(addon);
        ...
        new UnplaceableBlock(
                ...
                RecipeTypes.WANDERING_PIGLIN_TRADE,
                RecipeTypes.createTradingRecipe(
                        Converter.getItem(Stacks.QUARTZ_BLANK),
                        NetheoBalls.CITRUS,
                        20
                )
        ).register(addon);
        ...
        new PurificationBarometer(
                ...
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[]{
                        Converter.getItem(SlimefunItems.ZINC_INGOT), glass, Converter.getItem(SlimefunItems.ZINC_INGOT),
        ...
        new PurificationScanner(
                ...
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[]{
                        Converter.getItem(SlimefunItems.BILLON_INGOT), glass, Converter.getItem(SlimefunItems.BILLON_INGOT),
                        glass, Converter.getItem(Stacks.PURIFICATION_BAROMETER), glass,
                        Converter.getItem(SlimefunItems.BILLON_INGOT), glass, Converter.getItem(SlimefunItems.BILLON_INGOT),
                }
        ).register(addon);
        ...
        new SlimefunItem(
                ...
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[]{
                        Converter.getItem(SlimefunItems.REINFORCED_ALLOY_INGOT), Converter.getItem(SlimefunItems.REINFORCED_ALLOY_INGOT), Converter.getItem(SlimefunItems.REINFORCED_ALLOY_INGOT),
                        null, glass, null,
                        null, glass, null,
                }
        ).register(addon);
        ...
        new MixingQuartz(
                ...
                new ItemStack[]{
                        null, quartz, null,
                        quartz, Converter.getItem(Stacks.HARVESTING_TOOL), quartz,
                        Converter.getItem(Stacks.SAINTLY_SEED), glass, Converter.getItem(Stacks.SAINTLY_SEED),
                },
                50
        ).register(addon);
        ...
        new EnderCake(
                ...
                new ItemStack[]{
                        ...
                        Converter.getItem(Stacks.ADDON_JAM), Converter.getItem(Stacks.ADDON_JAM), Converter.getItem(Stacks.ADDON_JAM),
                        wheat, wheat, wheat,
                }
        ).register(addon);
        ...
        new NetherBeacon(
                ...
                new ItemStack[]{
                        null, null, null,
                        null, Converter.getItem(Stacks.ELEMENTAL_CRYSTAL), null,
        ...
        new BeaconSiphoningBlock(
                ...
                new ItemStack[]{
                        null, null, null,
                        null, Converter.getItem(Stacks.ELEMENTAL_CRYSTAL), null,
                        null, Converter.getItem(Stacks.QUARTZ_BLANK), null
                },
                1,
                10,
                1
        ...
        new BeaconSiphoningBlock(
                ...
                new ItemStack[]{
                        null, null, null,
                        null, Converter.getItem(Stacks.VACUUM_CRYSTAL), null,
                        null, Converter.getItem(Stacks.QUARTZ_BLANK), null
                },
                2,
                15,
        ...
        new BeaconSiphoningBlock(
                ...
                new ItemStack[]{
                        null, null, null,
                        null, Converter.getItem(Stacks.IRREGULAR_CRYSTAL), null,
                        null, Converter.getItem(Stacks.QUARTZ_BLANK), null
                },
                3,
                20,
        ...
        new Analyser(
                ...
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[]{
                        Converter.getItem(SlimefunItems.DAMASCUS_STEEL_INGOT), glass, Converter.getItem(SlimefunItems.DAMASCUS_STEEL_INGOT),
                        Converter.getItem(SlimefunItems.BRASS_INGOT), glass, Converter.getItem(SlimefunItems.BRASS_INGOT),
                        Converter.getItem(SlimefunItems.DAMASCUS_STEEL_INGOT), redstone, Converter.getItem(SlimefunItems.DAMASCUS_STEEL_INGOT),
                },
                Set.of(
        ...
        new Analyser(
                ...
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[]{
                        Converter.getItem(SlimefunItems.REINFORCED_ALLOY_INGOT), glass, Converter.getItem(SlimefunItems.REINFORCED_ALLOY_INGOT),
                        Converter.getItem(SlimefunItems.BRASS_INGOT), Converter.getItem(Stacks.SEED_ANALYSER), Converter.getItem(SlimefunItems.BRASS_INGOT),
                        Converter.getItem(SlimefunItems.REINFORCED_ALLOY_INGOT), redstone, Converter.getItem(SlimefunItems.REINFORCED_ALLOY_INGOT),
                },
                Set.of(
        ...
        new PurificationSeed(
                ...
                RecipeTypes.createWorldDropRecipe(Converter.getItem(Stacks.PURIFICATION_SEED), new ItemStack(Material.SOUL_SOIL), 0.05)
        )
        ...
        new HarvestableSeed(Stacks.ADDON_BERRY_SEED)
                .setHarvestingResult(Converter.getItem(Stacks.ADDON_BERRY))
